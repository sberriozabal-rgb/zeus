...
| `checklist-turno` | **Duplicado funcional de `apertura-cierre-turno`** con licencia incompatible: dice *"uso libre, incluido el comercial"*. Ver [`catalogo/ESTADO-GATES.md`](catalogo/ESTADO-GATES.md). |
